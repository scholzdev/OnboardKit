...
@available(iOS 13.0, *)
public struct OKPage: Identifiable, Decodable {
    ...
    /// Specifies whether to show an optional button.w
    ...
    public init(title: String, rows: [OKPageRow], mainButtonTitle: String? = nil) {
        self.title = title
        self.rows = rows
    ...
    public init(title: String, rows: [OKPageRow], mainButtonTitle: String? = nil, accentColor: Color) {
    ...
    public init(title: String, rows: [OKPageRow], mainButtonTitle: String? = nil, optionalButtonTitle: String, optionalButtonURL: URL?) {
        self.init(title: title, rows: rows, mainButtonTitle: mainButtonTitle)
    ...
    public init(title: String, rows: [OKPageRow], accentColor: Color, mainButtonTitle: String? = nil, optionalButtonTitle: String, optionalButtonURL: URL?) {
        self.init(title: title, rows: rows, mainButtonTitle: mainButtonTitle)
        self.accentColor = accentColor
        self.isShowingOptionalButton = true
        self.optionalButtonTitle = optionalButtonTitle
    ...
    public init(from decoder: Decoder) throws {
        ...
        rows = try container.decode([OKPageRow].self, forKey: .rows)
